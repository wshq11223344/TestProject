package com.example.testpproject.async;//package async;
//
...
//
//        Log.e("---sdcad--", Environment.getExternalStorageDirectory().getPath());// SD卡路径/storage/sdcard
...
////                DownloadAsyncTask asyncTask = new DownloadAsyncTask(mTextResult);
////                asyncTask.execute();
//                // executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR) 可以同时运行5个
//            }
//        });
//
//
...
//
//                // 串行运行
//                downTask.execute("http://10.50.8.79:8088/elife/test.apk");
//
//                // 最多允许5个并行运行
